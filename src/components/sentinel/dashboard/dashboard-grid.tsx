...
import type { WidgetId } from "@/lib/dashboard-config";
...
function SortableTile({
  ...
  widgetId: WidgetId;
  size: import("@/lib/dashboard-config").WidgetSize;
  onRemove: (id: WidgetId) => void;
  onResize: (id: WidgetId, size: import("@/lib/dashboard-config").WidgetSize) => void;
}) {
