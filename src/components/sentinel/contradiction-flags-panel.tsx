  ...
  return (
    <div className={`rounded-[8px] border overflow-hidden transition-opacity ${
      ...
      >
        ...
        <span className="text-[11px] font-medium text-foreground/75 flex-1 truncate">
          {checkLabel}
        </span>
      ...
      {expanded && (
        <div className="px-2.5 pb-2.5 border-t border-white/[0.04] pt-2 space-y-2">
          <p className="text-[11px] text-foreground/65 leading-relaxed">{flag.description}</p>
            ...
            <div className="space-y-1.5 pt-0.5">
              ...
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  disabled={reviewing}
                  className="flex-1 flex items-center justify-center gap-1 rounded-[6px] border border-white/[0.06] bg-white/[0.02] px-2 py-1 text-[10px] text-muted-foreground/50 hover:text-foreground/70 transition-colors disabled:opacity-40"
                >
                ...
                {!showNote && (
                  <button
                    ...
                    className="flex items-center gap-0.5 px-1.5 text-[10px] text-muted-foreground/25 hover:text-muted-foreground/50"
                  >
      ...
      >
        ...
        {!loading && (
          <>
            ...
            {!hasFlags && (
              <span className="text-[9px] text-muted-foreground/25">No flags</span>
            )}
          </>
        )}
      ...
      {open && (
        <div className="px-3 pb-3 border-t border-white/[0.04] pt-2.5 space-y-2">
          ...
          <button
            ...
            onClick={handleScan}
            disabled={scanning}
            className="flex items-center gap-1.5 rounded-[7px] border border-white/[0.06] bg-white/[0.02] px-2.5 py-1 text-[10px] text-muted-foreground/50 hover:text-foreground/70 hover:border-white/[0.10] transition-colors disabled:opacity-40"
          >
            {scanning
          ...
          {!loading && !hasFlags && !scanning && (
            <p className="text-[10px] text-muted-foreground/30 italic px-0.5">
          ...
          {!loading && reviewedFlags.length > 0 && (
            <div className="pt-1 border-t border-white/[0.04]">
              <p className="text-[9px] text-muted-foreground/25 uppercase tracking-wider mb-1.5">
          ...
          {/* Caveat */}
          <p className="text-[9px] text-muted-foreground/20 leading-relaxed px-0.5 pt-1">
