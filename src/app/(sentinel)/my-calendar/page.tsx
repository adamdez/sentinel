...
const events = [
  { time: "9:00 AM", title: "Morning Dial Session", type: "Recurring", color: "bg-neon/10 border-neon/20 text-neon" },
          ...
          <GlassCard hover={false}>
            ...
            <div className="space-y-3">
              {events.map((event) => (
                <div
                  key={event.title}
                  className={`flex items-center gap-4 p-3 rounded-lg border ${event.color} transition-colors hover:brightness-110`}
                >
