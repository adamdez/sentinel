  ...
  return (
    <div className="border-b border-white/[0.03] last:border-0 py-2.5 space-y-1">
      <div className="flex items-center gap-2 flex-wrap">
        <Badge variant="outline" className={`text-[9px] px-1.5 py-0 ${EVAL_VERDICT_COLORS[rating.verdict]}`}>
        ...
        <code className="text-[9px] text-muted-foreground/30 font-mono">
      ...
      {rating.reviewer_note && (
        <p className="text-[10px] text-muted-foreground/60 leading-relaxed pl-0.5">
          {rating.reviewer_note}
        </p>
      )}
      ...
      {showOutput && rating.output_snapshot && (
        <pre className="text-[9px] text-muted-foreground/40 bg-white/[0.02] rounded p-2 whitespace-pre-wrap max-h-28 overflow-auto">
          {rating.output_snapshot}
        </pre>
      )}
    </div>
        ...
        <div className="space-y-2.5 pt-1 border-t border-white/[0.04]">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <label className="text-[9px] text-muted-foreground/40 uppercase tracking-wide">Run ID</label>
              <Input
                value={runId}
            ...
            <div className="space-y-1">
              <label className="text-[9px] text-muted-foreground/40 uppercase tracking-wide">Workflow</label>
              <select
                value={wf}
            ...
            <div className="space-y-1">
              <label className="text-[9px] text-muted-foreground/40 uppercase tracking-wide">Prompt version</label>
              <Input
                value={version}
            ...
            <div className="space-y-1 col-span-2">
              <label className="text-[9px] text-muted-foreground/40 uppercase tracking-wide">Output snapshot (optional)</label>
              <Input
                value={snapshot}
    ...
    <GlassCard className="p-4 space-y-3">
      <div className="flex items-center justify-between gap-2 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <Badge variant="outline" className="text-[9px]">{ratings.length}</Badge>
        </div>
        <div className="flex gap-1.5 flex-wrap">
          <select
            value={workflowFilter}
            onChange={e => setWorkflowFilter(e.target.value as EvalWorkflow | "all")}
            className="h-6 text-[10px] rounded border border-white/[0.06] bg-background text-muted-foreground px-1.5"
          >
