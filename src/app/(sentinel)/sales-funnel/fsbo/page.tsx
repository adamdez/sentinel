...
const DISTRESS_COLORS: Record<string, { text: string; bg: string; border: string }> = {
  ...
  fsbo: { text: "text-green-400", bg: "bg-green-500/10", border: "border-green-500/25" },
...
const SOURCE_BADGES: Record<string, { label: string; text: string; bg: string; border: string }> = {
  craigslist: { label: "CL", text: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/25" },
  facebook: { label: "FB", text: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/25" },
  fb: { label: "FB", text: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/25" },
  fb_craigslist: { label: "FB/CL", text: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/25" },
  fsbo: { label: "FSBO", text: "text-green-400", bg: "bg-green-500/10", border: "border-green-500/25" },
  zillow_fsbo: { label: "Zillow", text: "text-blue-300", bg: "bg-blue-500/10", border: "border-blue-500/25" },
  fsbo_com: { label: "FSBO.com", text: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/25" },
};
                        ...
                        >
                          ...
                          <td className="px-3 py-3 text-right">
                            ...
                            {askingPrice && row.estimated_value ? (
                              <div className={cn("text-xs tabular-nums", row.estimated_value > askingPrice ? "text-emerald-400" : "text-muted-foreground")}>
