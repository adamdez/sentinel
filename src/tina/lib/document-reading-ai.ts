...
const TINA_ALLOWED_FACT_LABELS = [
  ...
  "Net income clue",
  "Payroll clue",
  "Payroll tax form clue",
  "Sales tax clue",
  "Owner draw clue",
  "Intercompany transfer clue",
  "Related-party clue",
  "EIN clue",
  "Prior-year carryover clue",
  "Carryover amount clue",
  "Tax election clue",
  "Election detail clue",
  "Ownership record clue",
  "Ownership percentage clue",
  "Fixed asset clue",
...
function buildPrompt(document: TinaStoredDocument): string {
  ...
  return [
    ...
    "When the paper appears to be a prior return, carryover schedule, ownership document, payroll form, or asset/depreciation paper, prefer precise structured clues over generic summaries.",
    "Examples of useful grounded facts: carryover type or amount, election detail, ownership percentage, payroll filing quarter, asset placed-in-service date, or depreciation schedule presence.",
