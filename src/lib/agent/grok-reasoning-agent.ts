      ...
      messages: [
        {
          ...
          content: [
            ...
            "Be concise. Only recommend crawlers that exist: obituary, court_docket, utility_shutoff, propertyradar, attom, craigslist_fsbo.",
...
function parseGrokDirective(raw: string): GrokDirective {
  const fallback: GrokDirective = {
    nextCrawlersToRun: ["obituary", "court_docket", "utility_shutoff", "propertyradar", "attom", "craigslist_fsbo"],
    priorityAdjustments: [],
