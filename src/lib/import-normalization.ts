...
const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  { field: "owner_name", label: "Owner Name", group: "Identity", aliases: ["owner name", "owner", "owner full name", "taxpayer", "name", "full name", "input name"] },
  ...
  { field: "property_address", label: "Property Address", group: "Property", aliases: ["property address", "site address", "property street", "address", "street address", "property address line 1", "input address", "latest address"] },
  { field: "property_city", label: "Property City", group: "Property", aliases: ["property city", "site city", "city", "input city", "latest city"] },
  { field: "property_state", label: "Property State", group: "Property", aliases: ["property state", "state", "st", "input state", "latest state"] },
  { field: "property_zip", label: "Property Zip", group: "Property", aliases: ["property zip", "property zipcode", "zip", "zip code", "postal code", "zipcode", "input zipcode", "latest zipcode"] },
  ...
  { field: "phone", label: "Primary Phone", group: "Contact", aliases: ["phone", "owner phone", "contact phone", "mobile", "cell", "phone 1", "phone1", "wireless 1", "primary phone", "primary phone 1", "primary phone1", "primary mobile", "primary mobile 1", "primary mobile phone 1", "primary mobile phone1", "mobile1"] },
  { field: "phone2", label: "Phone 2", group: "Contact", aliases: ["phone 2", "phone2", "secondary phone", "other phone", "alternate phone", "wireless 2", "mobile 2", "mobile-2", "mobile2", "secondary phone 1", "secondary phone1", "secondary mobile", "secondary mobile 1", "secondary mobile phone 1", "secondary mobile phone1"] },
  { field: "phone3", label: "Phone 3", group: "Contact", aliases: ["phone 3", "phone3", "wireless 3", "mobile 3", "mobile-3", "mobile3"] },
  { field: "phone4", label: "Phone 4", group: "Contact", aliases: ["phone 4", "phone4", "wireless 4", "mobile 4", "mobile-4", "mobile4"] },
  { field: "phone5", label: "Phone 5", group: "Contact", aliases: ["phone 5", "phone5", "wireless 5", "mobile 5", "mobile-5", "mobile5"] },
  { field: "phone6", label: "Phone 6", group: "Contact", aliases: ["phone 6", "phone6", "landline 1", "landline-1"] },
  { field: "phone7", label: "Phone 7", group: "Contact", aliases: ["phone 7", "phone7", "landline 2", "landline-2"] },
  { field: "phone8", label: "Phone 8", group: "Contact", aliases: ["phone 8", "phone8", "landline 3", "landline-3"] },
  { field: "phone9", label: "Phone 9", group: "Contact", aliases: ["phone 9", "phone9", "landline 4", "landline-4"] },
  { field: "phone10", label: "Phone 10", group: "Contact", aliases: ["phone 10", "phone10", "landline 5", "landline-5"] },
