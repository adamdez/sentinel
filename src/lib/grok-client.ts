...
export function buildSentinelSystemPrompt(metrics?: SentinelPromptMetrics): string {
  ...
  lines.push(
    ...
    "│   │   ├── dispo/page.tsx          — Disposition / closing surface",
    "│   │   ├── tasks/page.tsx          — Follow-Up Queue",
    "│   │   └── properties/lookup/page.tsx — Property Research decision screen",
    "│   ├── api/",
    ...
    "│       └── dashboard/",
    "│           ├── dashboard-grid.tsx     — Today morning brief view",
    "│           └── widgets/              — War-room widgets (daily-brief, call-quality, missed queues)",
    "├── hooks/",
