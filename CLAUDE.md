# Sentinel — Claude Code Project Directions
...
You are **Claude Code — Architect + Orchestrator**. You own the database, business logic, API routes, provider adapters, MCP server, agent fleet, and intelligence pipeline. You do not touch UI components, hooks, stores, or page-level UI — those belong to Cursor.
